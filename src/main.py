...
model = Embedding(input_size=800, crop=800, output_size=50, make_initial_preprocess=False)
SingleTriplet(model=model).train(batch_size=16, epochs=50, epoch_start=6, step_start=0)
